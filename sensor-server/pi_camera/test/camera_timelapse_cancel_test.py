...
print("Connected")
socket.send("SENSOR_REQ,DEV=PI_CAMERA,SUB_DEV=TIMELAPSE,CMD=CAPTURE,SIZE=1,VFLIP=TRUE,FILE_PRE=/home/pi/Pictures/timelapse-,DELAY=1,FRAMES=10,SENSOR_REQ_END")
message = socket.recv()
...
#
# Cancel the timelapse
# 
socket.send("SENSOR_REQ,DEV=PI_CAMERA,SUB_DEV=TIMELAPSE,CMD=CANCEL,SENSOR_REQ_END")
message = socket.recv()
print("Received Pi_Camera sensor reply:",message)
